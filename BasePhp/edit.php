...
if (!empty($_GET['add']) && !empty($_GET['rollnumber'])) {
    ...
    $sql = "insert into tbl_student (roll_no, first_name, last_name, gender, fee) Values ('" . $roll_number . "','" . $first_name . "','" . $last_name . "','" . $gender . "','" . $fee . "')";
} elseif (!empty($_GET['edit'])) {

    $sql = "update tbl_student SET first_name='" . $first_name . "', last_name='" . $last_name . "', gender='" . $gender . "', fee='" . $fee . "' where id=$id" . $update_id;
}
        ...
        <div class="content">
            ...
            <form>
                <div class="field-group">
                    <p>Roll Number:</p>
                        <input type="text" name="rollnumber" value="<?php echo $row['roll_no']; ?>" />
                </div>
                ...
                <div class="field-group ib">
                    ...
                    if (!empty($_GET['id'])) {
                        ...
                        <input type="submit" style="padding: 11px 46px 11px 20px;" value="Update">
                        <?php
                    } else {
                        ?>
